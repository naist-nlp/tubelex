...
\multirow[c]{3}{*}{\makebox[6pt][l]{\rotatebox[origin=c]{90}{speech}}} & BNC-Spoken & {\cellcolor[HTML]{2D7DBB}} \color[HTML]{F1F1F1} 0.701 & {---} & {---} \\
 ...
 & CSJ & {---} & {\cellcolor[HTML]{206FB4}} \color[HTML]{F1F1F1} 0.562 & {---} \\
\hline
\multirow[c]{7}{*}{\makebox[6pt][l]{\rotatebox[origin=c]{90}{film/TV subtitles}}} & ACTIV-ES & {---} & {---} & {\cellcolor[HTML]{E9F2FA}} \color[HTML]{000000} -0.516 \\
 ...
 & LaboroTV1+2 & {---} & {\cellcolor[HTML]{1460A8}} \color[HTML]{F1F1F1} 0.602 & {---} \\
...
\hline
\multirow[c]{3}{*}{\makebox[6pt][l]{\rotatebox[origin=c]{90}{other}}} & GINI & {\cellcolor[HTML]{F7FBFF}} \color[HTML]{000000} 0.349 & {\cellcolor[HTML]{6FB0D7}} \color[HTML]{F1F1F1} 0.378 & {---} \\
 & Wikipedia & {\cellcolor[HTML]{4997C9}} \color[HTML]{F1F1F1} 0.651 & {\cellcolor[HTML]{3F8FC5}} \color[HTML]{F1F1F1} 0.478 & {\cellcolor[HTML]{DFECF7}} \color[HTML]{000000} -0.454 \\
...
\hline
\multirow[c]{4}{*}{\makebox[6pt][l]{\rotatebox[origin=c]{90}{our\vphantom{l}}}} & TUBELEX\textsubscript{default} & {\cellcolor[HTML]{105BA4}} \color[HTML]{F1F1F1} 0.766 & {\cellcolor[HTML]{084E98}} \color[HTML]{F1F1F1} 0.652 & {\cellcolor[HTML]{084E98}} \color[HTML]{F1F1F1} 0.604 \\
